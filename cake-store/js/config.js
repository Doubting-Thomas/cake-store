export const navBtn = document.querySelector(".nav__cart--btn");
export const navCart = document.querySelector(".cart");
export const btnCart = document.querySelectorAll(".btn-info");
